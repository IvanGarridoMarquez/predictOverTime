...
#        train_setDocs=curBlog.getPostsFromAYear(curr_year)
#        if v:
...
#-----removed from the full experiment        
...
#plOT.plotBehaviorN(xlbWA,dat_crvWA,lb_crv,legends,"../plots/"+blog+"_recWA_svc_ovrtm.png")
